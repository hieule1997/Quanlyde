$(document).ready(function () {
    ...
    $("#r_tao_de").click(function () {
        ...
        $.ajax({
            ...
            url: location.href,
            data: {
                'csrfmiddlewaretoken': $("input[name=csrfmiddlewaretoken]").val(), 'ten_de': ten_de, 'random': '',
    ...
    $('#delete_exam').click(function () {
        if (confirm("Bạn có chắc chắn muốn xóa ?")) {
            $.ajax({
                ...
                type: "POST",
                data: {
                    'id': $('#exam input[name=exam_id]').val(), 'delete': '',
    ...
    setTimeout(function () {
        $('#wizard').find('.buttonFinish').first().click(function () {
            ...
            $.ajax({
                ...
                url: location.href,
                data: {
                    'csrfmiddlewaretoken': token, 'ten_de': ten_de, 'mon': mon, 'loai_de': loai_de,
